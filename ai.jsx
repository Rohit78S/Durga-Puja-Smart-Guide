...
import { Send, Sparkles, X, MessageCircle, TrendingUp, MapPin, Clock, Users } from 'lucide-react';
...
const AIPujaAssistant = () => {
  ...
  // Sample pandal data - this should match your actual data structure
  ...
  const getSmartRecommendations = (query) => {
    ...
    let scored = pandalDatabase.map(pandal => {
      ...
      // General popularity (avoid high crowds unless specifically requested)
